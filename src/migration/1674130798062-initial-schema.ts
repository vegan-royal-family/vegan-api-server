...
export class initialSchema1674130798062 implements MigrationInterface {
  name = 'initialSchema1674130798062';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`file\` (\`id\` int NOT NULL AUTO_INCREMENT, 
      \`target\` enum ('default') NOT NULL, 
    ...
    await queryRunner.query(
      ...
      \`thumbnailFileId\` bigint NOT NULL, 
      \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), 
      \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), 
      \`deletedAt\` datetime(6) NULL, 
      PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    ...
    await queryRunner.query(
      `CREATE TABLE \`like\` (\`id\` int NOT NULL AUTO_INCREMENT, 
      \`userId\` bigint NOT NULL, 
      \`target\` enum ('restaurant') NOT NULL, 
      \`targetId\` varchar(50) NOT NULL, 
      \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), 
      PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE \`recipe_step\` (\`id\` int NOT NULL AUTO_INCREMENT, 
    ...
    await queryRunner.query(
      ...
      \`star\` double UNSIGNED NOT NULL DEFAULT '0', 
      \`latitude\` double UNSIGNED NULL, 
      \`longitude\` double UNSIGNED NULL, 
      ...
      \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), 
      \`deletedAt\` datetime(6) NULL, 
      INDEX \`IDX_d8ec90bafca4e22a93a0e66461\` (\`title\`), 
      PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      ...
      \`IsPublic\` tinyint NOT NULL COMMENT '공개 여부' DEFAULT 1, 
      \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), 
      \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), 
      \`deletedAt\` datetime(6) NULL, 
      INDEX \`IDX_3d5c1c70c7e0c13e1b2b289a79\` (\`content\`), 
      PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      ...
      \`role\` enum ('admin', 
      'designer', 
      'user') NOT NULL DEFAULT 'user', 
      \`nickname\` varchar(20) NOT NULL, 
      \`veganFor\` json NOT NULL, 
      \`veganTypeId\` bigint NOT NULL, 
      \`profileFileId\` bigint NOT NULL, 
      \`reportedCount\` int UNSIGNED NOT NULL DEFAULT '0', 
      \`reviewCount\` int UNSIGNED NOT NULL DEFAULT '0', 
      \`recipeCount\` int UNSIGNED NOT NULL DEFAULT '0', 
      \`likeCount\` int UNSIGNED NOT NULL DEFAULT '0', 
      \`visitCount\` int UNSIGNED NOT NULL DEFAULT '0', 
      \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), 
      \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), 
    ...
    await queryRunner.query(
      `CREATE TABLE \`vegan_type\` (\`id\` int NOT NULL AUTO_INCREMENT, 
    ...
    await queryRunner.query(
      `CREATE TABLE \`visit\` (\`id\` int NOT NULL AUTO_INCREMENT, 
      \`title\` varchar(255) NOT NULL, 
      \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), 
      \`deletedAt\` datetime(6) NULL, 
      PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
